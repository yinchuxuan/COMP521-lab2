/* Based on GNU ld version 2.23.52.0.1-55.el7 20130226 -- 2/19/2017 dbj */
...
SECTIONS
{
  ...
  /* Yalnix: Change starting address */
  /* PROVIDE (__executable_start = SEGMENT_START("text-segment", 0x400000)); . = SEGMENT_START("text-segment", 0x400000) + SIZEOF_HEADERS; */
  PROVIDE (__executable_start = SEGMENT_START("text-segment", 0xc101000)); . = SEGMENT_START("text-segment", 0xc101000) + SIZEOF_HEADERS;
  .interp         : { *(.interp) }
  ...
  /* Yalnix: move etext defintion to after the ALIGN below */
  /* PROVIDE (__etext = .); */
  /* PROVIDE (_etext = .); */
  /* PROVIDE (etext = .); */
  ...
  /* Yalnix: Change alignment to just our PAGESIZE */
  /* . = ALIGN (CONSTANT (MAXPAGESIZE)) - ((CONSTANT (MAXPAGESIZE) - .) & (CONSTANT (MAXPAGESIZE) - 1)); . = DATA_SEGMENT_ALIGN (CONSTANT (MAXPAGESIZE), CONSTANT (COMMONPAGESIZE)); */
  . = ALIGN (0x1000);
  . = DATA_SEGMENT_ALIGN (0x1000, 0x1000); 
  /* Yalnix: etext defintion moved from above */
  /* Yalnix: Also force _etext to always be defined by xc */
  PROVIDE (__etext = .);
  _etext = .;
  PROVIDE (etext = .);
  /* Exception handling  */
